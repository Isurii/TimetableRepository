...
function checkdetailsStudent(){
	...
	if ($group=="students") {
		...
		if ($countcheck==0) {
			# code...
			echo '<div class="alert alert-primary"><strong>Whats up '.$name.', Welcome to your timetable companion.You need to provide your personal details to be able to get personalized content.Simply click <a href="student_details_view.php">HERE</a> to get started</strong></div>';
		}
	}
}
...
function getmytasks(){
	...
	if ($countcheck==0) {
		...
		<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
		<b>Whoopsie,You have no task today.You can schedule some <a class="btn btn-success btn-sm" href="personal_time_table_view.php">HERE</a></b></b></div>';
	}
